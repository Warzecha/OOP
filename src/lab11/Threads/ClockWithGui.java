...
//                System.out.printf("%02d:%02d:%02d\n",time.getHour(),time.getMinute(),time.getSecond());
    ...
    public void paintComponent(Graphics g){
        ...
        AffineTransform hourHand = g2d.getTransform();
        g2d.rotate(time.getHour()%12*2*Math.PI/12);
        g2d.drawLine(0,0,0,-50);
        g2d.setTransform(hourHand);


        AffineTransform minuteHand = g2d.getTransform();
        g2d.rotate(time.getMinute()%60*2*Math.PI/60);
        g2d.drawLine(0,0,0,-80);
        g2d.setTransform(minuteHand);

        AffineTransform secondHand = g2d.getTransform();
        g2d.rotate(time.getSecond()%60*2*Math.PI/60);
        g2d.drawLine(0,0,0,-100);
        g2d.setTransform(secondHand);
